...
async function updateBasicDetailsRoute(req, res) {
    // console.log("updatebasicroute");
    try {
        var basicDetailsObj = {
...
async function updateEduDetailsRoute(req, res) {
    try {
...
async function updateWorkExpDetailsRoute(req, res) {
    try {
        var queryId = req.body.insertId;
...
async function updateLanguageDetailsRoute(req, res) {
    try {
        var queryId = req.body.insertId;
...
async function updateTechDetailsRoute(req, res) {
    try {
        var queryId = req.body.insertId;
...
async function updatePreferenceDetailsRoute(req, res) {
    try {
        var queryId = req.body.insertId;
...
async function updateReferenceDetailsRoute(req, res) {
    try {
        var queryId = req.body.insertId;
...
module.exports ={updateBasicDetailsRoute,updateEduDetailsRoute,updateWorkExpDetailsRoute,updateLanguageDetailsRoute,updateTechDetailsRoute,updateReferenceDetailsRoute,updatePreferenceDetailsRoute};