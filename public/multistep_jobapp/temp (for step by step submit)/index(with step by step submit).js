...
// hsc_percentage: 91,
// bachelor_course_name: 'BE',
// bachelor_university: 'GTU',
// bachelor_passing_year: 2024,
// bachelor_percentage: 92,
// master_course_name: 'ME',
// master_university: 'GTU',
// master_passing_year: 2025,
// master_percentage: 89,
//     workId: [114, 115],
//     company_name: ['A', 'v'],
//     designation_company: ['BA2', 'b4'],
//     from_date_company: ['1/1/2020', '1/1/2020'],
//     to_date_company: ['1/1/2020', '1/1/2022'],
//     language_1: ['hindi', 'read', 'speak', ''],
//     language_2: ['english', 'read', 'write', ''],
//     language_3: ['gujarati', 'read', 'write', 'speak'],
//     tech_1: ['php', 'beginer'],
//     tech_2: ['mysql', 'beginer'],
//     tech_3: ['laravel', 'mideator'],
//     tech_4: ['oracle', 'mideator'],
//     refId: [55, 56],
//     reference_name: ['AB2', 'cd'],
//     reference_contact: ['9876543211', '9876543210'],
//     reference_relation: ['AB', 'cd'],
//     prefId: [79, 80, 81],
//     prefered_location: ['A', 'B', 'c2'],
//     notice_period: 1.5,
//     expected_ctc: 16,
//     current_ctc: 4,
...
function changeSlide(action) {
	...
	if (action === 1) {
		...
		if (currentSlide === 1) submitEduDetails();
		if (currentSlide === 2) submitWorkDetails();
		if (currentSlide === 3) submitLanguageDetails();
		if (currentSlide === 4) submitTechDetails();
		if (currentSlide === 5) submitReferencesDetails();
		if (currentSlide === 6) submitPreferenceDetails();
...
async function submitBasicDetails() {
	...
	var body = {
		...
		state: reqBody.state,
		relationship_status: reqBody.relationship_status,
		dob: reqBody.dob,
		insertId: insertId
	}
...
async function submitEduDetails() {
	...
	var body = {
		insertId: insertId,
		ssc_board_name: reqBody.ssc_board_name,
		ssc_passing_year: reqBody.ssc_passing_year,
		ssc_percentage: reqBody.ssc_percentage,
		hsc_board_name: reqBody.hsc_board_name,
		hsc_passing_year: reqBody.hsc_passing_year,
		hsc_percentage: reqBody.hsc_percentage,
		bachelor_course_name: reqBody.bachelor_course_name,
		bachelor_university: reqBody.bachelor_university,
		bachelor_passing_year: reqBody.bachelor_passing_year,
		bachelor_percentage: reqBody.bachelor_percentage,
		master_course_name: reqBody.master_course_name,
		master_university: reqBody.master_university,
		master_passing_year: reqBody.master_passing_year,
		master_percentage: reqBody.master_percentage,
	}


	var submitDetails = await fetch("/multistep-jobapp/api/insertEdudetails", {
		method: "post",
		headers: {
			'Accept': 'application/json',
			'Content-Type': 'application/json'
...
async function submitWorkDetails() {

	var body = {
		company_name: reqBody.company_name,
		designation_company: reqBody.designation_company,
		from_date_company: reqBody.from_date_company,
		to_date_company: reqBody.to_date_company,
		workId: reqBody.workId,
		insertId: insertId,

	}


	var submitDetails = await fetch("/multistep-jobapp/api/insertWorkDetails", {
		method: "post",
		headers: {
			'Accept': 'application/json',
			'Content-Type': 'application/json'
	...
	submitDetailsResult.insertWorkExpResult?.forEach(element => {
		reqBody.workId.push(element.insertId)
	});
	workExTableTag.innerHTML = generateWorkTable(reqBody);
...
async function submitLanguageDetails() {
	...
	var body = {
		language_1: reqBody.language_1,
		language_2: reqBody.language_2,
		language_3: reqBody.language_3,
		insertId: insertId,
	}


	var submitDetails = await fetch("/multistep-jobapp/api/insertLanguageDetails", {
		method: "post",
		headers: {
			'Accept': 'application/json',
			'Content-Type': 'application/json'
...
async function submitTechDetails() {

	var body = {
		tech_1: reqBody.tech_1,
		tech_2: reqBody.tech_2,
		tech_3: reqBody.tech_3,
		tech_4: reqBody.tech_4,
		insertId: insertId,
	}


	var submitDetails = await fetch("/multistep-jobapp/api/insertTechDetails", {
		method: "post",
		headers: {
			'Accept': 'application/json',
			'Content-Type': 'application/json'
...
async function submitReferencesDetails() {
	...
	var body = {
		reference_name: reqBody.reference_name,
		reference_contact: reqBody.reference_contact,
		reference_relation: reqBody.reference_relation,
		refId: reqBody.refId,
		insertId: insertId,
	...
	var submitDetails = await fetch("/multistep-jobapp/api/insertReferencesDetails", {
		method: "post",
		headers: {
			'Accept': 'application/json',
			'Content-Type': 'application/json'
...
async function submitPreferenceDetails() {
	...
	var body = {
		prefered_location: reqBody.prefered_location,
		notice_period: reqBody.notice_period,
		current_ctc: reqBody.current_ctc,
		expected_ctc: reqBody.expected_ctc,
	...
	var submitDetails = await fetch("/multistep-jobapp/api/insertPreferencesDetails", {
		method: "post",
		headers: {
			'Accept': 'application/json',
			'Content-Type': 'application/json'
