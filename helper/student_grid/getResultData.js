...
async function getResultData(id) {
    var getResultById = `select concat(s.firstname,' ',s.lastname)as name , r.stMId as id,su.subName,r.pracTotalMarks,r.pracOptainedMarks,r.theoryTotalMarks,r.theoryOptainedMarks,e.examName
