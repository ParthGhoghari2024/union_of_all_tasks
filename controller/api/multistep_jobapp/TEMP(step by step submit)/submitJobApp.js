const { dataExistBybDMId } = require("../../helper/dataExist");
const { insertBasicDetails, updateBasicDetails } = require("../../helper/dbHelperBasicDetails");
const { insertEducationDetails } = require("../../helper/dbHelperEducationDetails");
const { insertLanguageDetails } = require("../../helper/dbHelperLanguageDetails");
const { insertPreferenceDetails } = require("../../helper/dbHelperPreferenceDetails");
const { insertReferenceDetails } = require("../../helper/dbHelperReferenceDetails");
const { insertTechDetails } = require("../../helper/dbHelperTechDetails");
const { insertWorkExpDetails } = require("../../helper/dbHelperWorkExpDetails");
